report 50002 "KBS Suggest Vendor Payments"
{
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            begin
                ...
                SelectedDim.SetRange("Object ID", REPORT::"KBS Suggest Vendor Payments");
...
#pragma warning restore AA0470
    ...
    procedure SetPaymentHdr(PaymentHeader2: Record "Payment Voucher Header")
    begin
    ...
    local procedure MakePaymentLine(var GenJnlLine: Record "Gen. Journal Line")
    var
        Vend: Record Vendor;
    begin
        ...
        PaymentLine."Line No." := GenJnlLine."Line No.";
        PaymentLine.Insert();
        PaymentLine.Validate("Shortcut Dimension 1 Code", GenJnlLine."Shortcut Dimension 1 Code");
        PaymentLine.Validate("Shortcut Dimension 2 Code", GenJnlLine."Shortcut Dimension 2 Code");
        PaymentLine.Validate("Account No.", GenJnlLine."Account No.");
        PaymentLine."Applies-to Doc. Type" := GenJnlLine."Applies-to Doc. Type";
        PaymentLine."Applies-to Invoice No." := GenJnlLine."Applies-to Doc. No.";
        PaymentLine."Preferred Bank Account Code" := Vend."Preferred Bank Account Code";
        PaymentLine."Payment Details" := GenJnlLine.Description;
        PaymentLine."Dimension Set ID" := GenJnlLine."Dimension Set ID";
        PaymentLine.Validate("Currency Code", GenJnlLine."Currency Code");
        PaymentLine.Validate(Amount, GenJnlLine.Amount);
        PaymentLine.Modify();
    end;
