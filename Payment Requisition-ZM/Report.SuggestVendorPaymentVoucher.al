...
// report 50001 "Suggest Vendor Voucher Pmts"
// {
...
//                 GenJnlBatch.Get(GenJnlLine."Document No.");
//                 GenJnlLine.SetRange("Document No.", GenJnlBatch."No.");
...
//         GenJnlBatch: Record "Payment Voucher Header";
//         GenJnlLine: Record "Payment Voucher Line";
...
//     procedure SetGenJnlLine(NewGenJnlLine: Record "Payment Voucher Line")
//     begin
...
//     begin
//         // if not GenJnlBatch.Get( GenJnlLine."Document No.") then
...
//         PaymentVoucherHdr: Record "Payment Voucher Header";
//     begin
//         PaymentVoucherHdr.Get(VendLedgEntry."Document No.");
//         GenJnlLine.Init();
...
//         Vend2.CheckBlockedVendOnJnls(Vend2, 1, false);
//         GenJnlLine."Payment Details" := Vend2.Name;
...
//         if CheckCalcPmtDiscGenJnlVend(GenJnlLine, VendLedgEntry, 0, false) then
//             GenJnlLine.Amount := -(VendLedgEntry."Remaining Amount" - VendLedgEntry.GetRemainingPmtDiscPossible(PaymentVoucherHdr.Date))
//         else
...
//     var
//         GenJnlLine1: Record "Payment Voucher Line";
...
//                     HandledEntry := VendLedgEntry."Posting Date" <= PaymentVoucherHdr.Date;
...
//         GenJnlLine."Payment Details" := Vendor.Name;
...
//         GenJnlLine."Applies-to Invoice No." := TempVendorPaymentBuffer."Vendor Ledg. Entry Doc. No.";
...
//         IsHandled: Boolean;
//         PaymentVouhcerHdr: Record "Payment Voucher Header";
//     begin
//         IsHandled := false;
...
//         NextDocNo := NoSeriesBatch.SimulateGetNextNo(GenJnlBatch."No. Series", PaymentVouhcerHdr.Date, NextDocNo);
//     end;

//     local procedure UpdateDimensions(var GenJnlLine: Record "Payment Voucher Line")
//     var
//         DimBuf: Record "Dimension Buffer";
...
//     local procedure SetPostingDate(var GenJnlLine: Record "Payment Voucher Line"; DueDate: Date; PostingDate: Date): Boolean
//     begin
...
//     local procedure IsNotAppliedEntry(GenJournalLine: Record "Payment Voucher Line"; VendorLedgerEntry: Record "Vendor Ledger Entry"): Boolean
//     begin
...
//     local procedure IsNotAppliedToCurrentBatchLine(GenJournalLine: Record "Payment Voucher Line"; VendorLedgerEntry: Record "Vendor Ledger Entry"): Boolean
//     var
//         PaymentGenJournalLine: Record "Payment Voucher Line";
//     begin
...
//         PaymentGenJournalLine.SetRange("Applies-to Invoice No.", VendorLedgerEntry."Document No.");
//         exit(PaymentGenJournalLine.IsEmpty);
//     end;

//     local procedure IsNotAppliedToOtherBatchLine(GenJournalLine: Record "Payment Voucher Line"; VendorLedgerEntry: Record "Vendor Ledger Entry"): Boolean
//     var
//         PaymentGenJournalLine: Record "Payment Voucher Line";
//     begin
...
//     local procedure LogNotSuggestedPaymentMessage(GenJournalLine: Record "Payment Voucher Line")
//     begin
...
//     procedure CheckCalcPmtDiscGenJnlVend(GenJnlLine: Record "Payment Voucher Line"; OldVendLedgEntry2: Record "Vendor Ledger Entry"; ApplnRoundingPrecision: Decimal; CheckAmount: Boolean): Boolean
//     var
//         NewCVLedgEntryBuf: Record "CV Ledger Entry Buffer";
//         OldCVLedgEntryBuf2: Record "CV Ledger Entry Buffer";
//         PaymentVoucherHdr: Record "Payment Voucher Header";
//     begin
//         PaymentVoucherHdr.Get(GenJnlLine."Document No.");
//         //NewCVLedgEntryBuf."Document Type" := GenJnlLine."Document Type";
//         NewCVLedgEntryBuf."Posting Date" := PaymentVoucherHdr.Date;
