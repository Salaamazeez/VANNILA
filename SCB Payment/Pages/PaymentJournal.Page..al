...
//                     Visible = true;
//                     ToolTip = 'This action view the payment schedule';
//                     Image = List;
//                     trigger OnAction()
//                     var
...
//         GeneralJournalLine.SetFilter("Journal Template Name", '%1', Rec."Journal Template Name");
//         GeneralJournalLine.SetFilter("Journal Batch Name", '%1', Rec."Journal Batch Name");
//         GeneralJournalLine.SetRange("Bal. Account No.", Rec."Bal. Account No.");
//         GeneralJournalLine.SetRange("Payment Method Code", Rec."Payment Method Code");
//         GeneralJournalLine.SetFilter("Line No.", '%1', 0);
...
//     var
//         GetPaymentJnl: Codeunit "Payment - Get Payment";
//     begin
//         CurrPage.SetSelectionFilter(Rec);
//         GetPaymentJnl.SetPaymentTranHeader(PaymentHeader);
...
//     procedure SetPaymentJnlRec(var PaymentJnlRec: Record "Gen. Journal Line")
//     begin
//         PaymentJnlRec2 := PaymentJnlRec;
//     end;
